...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../Assets/Templates/Main/fonts/ionicons/Main/css/ionicons.min.css">
    <link rel="stylesheet" href="../Assets/Templates/Main/fonts/fontawesome/css/font-awesome.min.css">
  ...
  <body>
                    ...
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="Myprofile.php">Profile</a></li>
                         <li><a href="Booking.php">User Requests</a></li>
                        <li><a href="acceptedlist.php">Accepted List</a></li>
                        <li><a href="rejectedlist.php">Rejected List</a></li>
                        <li><a href="canceld.php">Canceled List</a></li>
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 ml-auto order-lg-2 position-relative mb-5" data-aos="fade-up">
            <figure class="img-absolute">
              <img src="../Assets/Templates/Main/images/food-1.jpg" alt="Image" class="img-fluid">
            </figure>
            <img src="../Assets/Templates/Main/images/img_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            <h2 class="heading">Welcome!</h2>
            <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
            <p><a href="AddRoom.php" class="btn btn-primary text-white py-2 mr-3">Add Room</a> <span class="mr-3 font-family-serif"><em>or</em></span> <a href="MyRoom.php" class="btn btn-primary text-white py-2 mr-3">My Room</a></p>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="../Assets/Templates/Main/images/img_1.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="../Assets/Templates/Main/images/img_2.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
                <h2>Family Room</h2>
          ...
          <div class="col-md-6 col-lg-4" data-aos="fade-up">
            <a href="#" class="room">
              <figure class="img-wrap">
                <img src="../Assets/Templates/Main/images/img_3.jpg" alt="Free website template" class="img-fluid mb-3">
              </figure>
              <div class="p-3 text-center room-info">
          ...
          <div class="col-md-12">
            <div class="home-slider major-caousel owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-1.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-1.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-2.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-2.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-3.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-3.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-4.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-4.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-5.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-5.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-6.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-6.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
              <div class="slider-item">
                <a href="../Assets/Templates/Main/images/slider-7.jpg" data-fancybox="images" data-caption="Caption for this image"><img src="../Assets/Templates/Main/images/slider-7.jpg" alt="Image placeholder" class="img-fluid"></a>
              </div>
            </div>
            <!-- END slider -->
          </div>
    ...
    <section class="section bg-image overlay" style="background-image: url('../Assets/Templates/Main/images/hero_3.jpg');">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-7">
          ...
          <div class="js-carousel-2 owl-carousel mb-5" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="../Assets/Templates/Main/images/person_1.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="../Assets/Templates/Main/images/person_2.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
            ...
            <div class="testimonial text-center slider-item">
              <div class="author-image mb-3">
                <img src="../Assets/Templates/Main/images/person_3.jpg" alt="Image placeholder" class="rounded-circle mx-auto">
              </div>
              <blockquote>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="../Assets/Templates/Main/images/img_1.jpg" alt="Image placeholder" class="img-fluid"></a>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="200">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="../Assets/Templates/Main/images/img_2.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 col-12 post" data-aos="fade-up" data-aos-delay="300">
            <div class="media media-custom d-block mb-4 h-100">
              <a href="#" class="mb-4 d-block"><img src="../Assets/Templates/Main/images/img_3.jpg" alt="Image placeholder" class="img-fluid"></a>
              <div class="media-body">
                <span class="meta-post">February 26, 2018</span>
